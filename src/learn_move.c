...
static void MoveRelearnerStateMachine(void)
{
    ...
    case MENU_STATE_PRINT_TEACH_MOVE_PROMPT:
        CreateYesNoMenu(&sMoveRelearnerYesNoMenuTemplate, FONT_NORMAL, 0, 2, 0x001, 14, 0);
        sMoveRelearner->state++;
        break;
...
static void PrintTextOnWindow(u8 windowId, const u8 *str, u8 x, u8 y, s32 speed, s32 colorIdx)
{
    ...
    AddTextPrinterParameterized4(windowId, FONT_NORMAL, x, y, letterSpacing, lineSpacing, sMoveRelearner->textColor, speed, str);
}
