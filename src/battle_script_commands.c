...
static void Cmd_drawlvlupbox(void)
{
    ...
    case 3:
        ...
        ShowBg(0);
        ShowBg(1);
        HandleBattleWindow(18, 3, 29, 13, WINDOW_BG1);
    ...
    case 8:
        if (gMain.newKeys != 0)
        {
            // Close level up box
            PlaySE(SE_SELECT);
            HandleBattleWindow(18, 3, 29, 13, WINDOW_BG1 | WINDOW_CLEAR);
            gBattleScripting.drawlvlupboxState++;
        }
        break;
    case 9:
...
static void DrawLevelUpWindow1(void)
{
    ...
    DrawLevelUpWindowPg1(B_WIN_LEVEL_UP_BOX, gBattleResources->beforeLvlUp->stats, currStats, TEXT_DYNAMIC_COLOR_5, TEXT_COLOR_DARK_GRAY, TEXT_DYNAMIC_COLOR_6);//Palette 5 in mGBA
}
...
static void DrawLevelUpWindow2(void)
{
    ...
    GetMonLevelUpWindowStats(&gPlayerParty[gBattleStruct->expGetterMonId], currStats);
    DrawLevelUpWindowPg2(B_WIN_LEVEL_UP_BOX, currStats, TEXT_DYNAMIC_COLOR_5, TEXT_COLOR_DARK_GRAY, TEXT_DYNAMIC_COLOR_6);//Palette 5 in mGBA
}
