...
const u8 gText_ExpShareTurnOn[] = _("Turned on the EXP.ALL.\pParty will now gain a\nportion of the\pExperience Points.{PAUSE_UNTIL_PRESS}"); //"Turned on the Exp. Share.\pParty will now gain a portion\nof the Experience Points.{PAUSE_UNTIL_PRESS}"
const u8 gText_ExpShareTurnOff[] = _("Turned off the EXP.ALL.\pParty will no longer\ngain a portion of any\pExperience Points.{PAUSE_UNTIL_PRESS}"); //"Turned off the Exp. Share.\pParty will no longer gain a portion\nof any Experience Points.{PAUSE_UNTIL_PRESS}"
