...
const u8 gText_Nidorino_1200Coins[] = _("NIDORINO{CLEAR_TO 0x4B}{FONT_SMALL} 1,200 COINS");
const u8 gText_Nidorina_1200Coins[] = _("NIDORINA{CLEAR_TO 0x4B}{FONT_SMALL} 1,200 COINS");
