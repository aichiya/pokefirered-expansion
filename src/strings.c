...
const u8 gText_MenuPokemon[] = _("FRAGMON");
...
const u8 gText_MysteryGiftCantUse[] = _("MYSTERY GIFT canÑ be used while\nthe Wireless Adapter is attached."); //"MYSTERY GIFT can't be used while\nthe Wireless Adapter is attached."
...
const u8 gText_SaveFileCorrupted[] = _("The save file is\ncorrupted.\pThe previous save file\nwill be used."); //"The save file is corrupted.\pThe previous save file will be\nloaded."
const u8 gText_SaveFileHasBeenDeleted[] = _("The save file has been\ndeleted...");
const u8 gText_1MSubCircuitBoardNotInstalled[] = _("The 1M sub-circuit board\nis not installed."); //"The 1M sub-circuit board is\nnot installed."
...
ALIGNED(4) const u8 gText_ABUTTONNext[] = _("{A_BUTTON}NEXT"); //"{A_BUTTON}NEXT"
ALIGNED(4) const u8 gText_ABUTTONNext_BBUTTONBack[] = _("{A_BUTTON}NEXT {B_BUTTON}BACK"); //"{A_BUTTON}NEXT {B_BUTTON}BACK"
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONNext_BBUTTONBack[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}NEXT {B_BUTTON}CANCEL"); //"{DPAD_UPDOWN}PICK {A_BUTTON}NEXT {B_BUTTON}CANCEL"
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONBBUTTONCancel[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}{B_BUTTON}CANCEL"); //"{DPAD_UPDOWN}PICK {A_BUTTON}{B_BUTTON}CANCEL"
ALIGNED(4) const u8 gText_ABUTTONExit[] = _("{A_BUTTON}EXIT");
const u8 gText_Boy[] = _("BOY");
const u8 gText_Girl[] = _("GIRL");
const u8 gText_PokedexTableOfContents[] = _("ARTBOOK   TABLE OF CONTENTS");
const u8 gText_PickOK[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}OK");
const u8 gText_Seen[] = _("SEEN:");
const u8 gText_Owned[] = _("OWN:");
const u8 gText_Kanto[] = _("KANTO");
const u8 gText_National[] = _("NATIONAL");
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}FRAGMON HABITATS");
const u8 gText_DexCategory_GrasslandPkmn[] = _("GRASSLAND"); //"Grassland POKéMON"
const u8 gText_DexCategory_ForestPkmn[] = _("FOREST"); //"Forest POKéMON"
const u8 gText_DexCategory_WatersEdgePkmn[] = _("WATER'S EDGE"); //"Water's-edge POKéMON"
const u8 gText_DexCategory_SeaPkmn[] = _("SEA"); //"Sea POKéMON"
const u8 gText_DexCategory_CavePkmn[] = _("CAVE"); //"Cave POKéMON"
const u8 gText_DexCategory_MountainPkmn[] = _("MOUNTAIN"); //"Mountain POKéMON"
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("ROUGH TERRAIN"); //"Rough-terrain POKéMON"
const u8 gText_DexCategory_UrbanPkmn[] = _("URBAN"); //"Urban POKéMON"
const u8 gText_DexCategory_RarePkmn[] = _("RARE"); //"Rare POKéMON"
const u8 gText_Search[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}SEARCH");
const u8 gText_Search2[] = _("{COLOR DYNAMIC_COLOR1}{SHADOW TRANSPARENT}SEARCH");
...
const u8 gText_ClosePokedex[] = _("CLOSE ARTBOOK");
...
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}FRAGMON LIST");
const u8 gText_PokemonList2[] = _("{COLOR DYNAMIC_COLOR1}{SHADOW TRANSPARENT}FRAGMON LIST");
const u8 gText_NumericalModeKanto[] = _("NUMERICAL MODE: KANTO");
const u8 gText_NumericalModeNational[] = _("NUMERICAL MODE: NATIONAL");
const u8 gText_PokemonListNoColor[] = _("FRAGMON LIST");
...
const u8 gText_PickFlipPageCheckCancel[] = _("{DPAD_LEFTRIGHT}PICK{PLUS}PAGE {A_BUTTON}CHECK {B_BUTTON}CANCEL"); //"{DPAD_LEFTRIGHT}PICK{PLUS}FLIP PAGE {A_BUTTON}CHECK {B_BUTTON}CANCEL"
const u8 gText_PokedexPokemon[] = _(" FRAGMON");
const u8 gText_HT[] = _("HT");
const u8 gText_WT[] = _("WT");
const u8 gText_PokedexQuotationMark[] = _("”"); // Unused
const u8 gText_Lbs[] = _("lb"); //"lbs."
...
const u8 gText_AreaUnknown[] = _("UNKNOWN"); //"AREA UNKNOWN"
const u8 gText_PokedexNo[] = _("{NO}");
const u8 gText_Page[] = _("PAGE");
ALIGNED(4) const u8 gText_WelcomeToHOF[] = _("Welcome to the\nHALL OF FAME!"); //"Welcome to the HALL OF FAME!"
...
const u8 gText_HOFNumber[] = _("No. {STR_VAR_1}"); //"HALL OF FAME No. {STR_VAR_1}"
const u8 gText_LeagueChamp[] = _("LEAGUE CHAMPION!\nCONGRATULATIONS!");
ALIGNED(4) const u8 gText_Number[] = _("No:"); //"No. "
ALIGNED(4) const u8 gText_Level[] = _("Lv:"); //"Lv. "
ALIGNED(4) const u8 gText_Name[] = _("NAME");
ALIGNED(4) const u8 gText_IDNumber[] = _("IDNo:"); //"IDNo."
...
const u8 gSaveStatName_Pokedex[] = _("ARTBOOK");
...
const u8 gText_Coins[] = _("{STR_VAR_1}"); //"{STR_VAR_1} COINS"
const u8 gText_Items2[] = _("ITEMS");
const u8 gText_PokeBalls2[] = _("BALLS");
const u8 gText_KeyItems2[] = _("KEY ITEMS");
const u8 gText_DepositItem[] = _("DEPOSIT"); //"DEPOSIT ITEM"
const u8 gText_CloseBag[] = _("CLOSE BAG");
const u8 gText_Var1IsSelected[] = _("{STR_VAR_1}\nis selected."); //"{STR_VAR_1} is\nselected."
const u8 gText_CantWriteMailHere[] = _("You canÑ write\nMAIL here."); //"You can't write\nMAIL here."
...
const u8 gText_ItemCantBeHeld[] = _("The {STR_VAR_1} canÑ be held."); //"The {STR_VAR_1} can't be held."
const u8 gText_TheStrVar1CantBeHeldHere[] = _("The {STR_VAR_1} canÑ be held\nhere."); //"The {STR_VAR_1} can't be held\nhere."
const u8 gText_DepositHowManyStrVars1[] = _("Deposit how many\n{STR_VAR_1}(s)?");
const u8 gText_DepositedStrVar2StrVar1s[] = _("Deposited {STR_VAR_2}\n{STR_VAR_1}(s).");
const u8 gText_NoRoomToStoreItems[] = _("ThereÙ no room to\nstore items."); //"There's no room to\nstore items."
const u8 gText_TossOutHowManyStrVar1s[] = _("Toss how many\n{STR_VAR_1}(s)?"); //"Toss out how many\n{STR_VAR_1}(s)?"
...
const u8 gText_OakForbidsUseOfItemHere[] = _("OAK: {PLAYER}!\nThis isnÑ the\ltime to use that!{PAUSE_UNTIL_PRESS}"); //"OAK: {PLAYER}!\nThis isn't the time to use that!{PAUSE_UNTIL_PRESS}"
const u8 gText_CantDismountBike[] = _("You canÑ dismount\nyour BIKE here.{PAUSE_UNTIL_PRESS}"); //"You can't dismount your BIKE here.{PAUSE_UNTIL_PRESS}"
const u8 gText_ExpShareTurnOn[] = _("Turned on the EXP.ALL.\nParty will now gain a\lportion of the\lExperience Points.{PAUSE_UNTIL_PRESS}"); //"Turned on the Exp. Share.\pParty will now gain a portion\nof the Experience Points.{PAUSE_UNTIL_PRESS}"
const u8 gText_ExpShareTurnOff[] = _("Turned off the EXP.ALL.\nParty will no longer\lgain a portion of any\lExperience Points.{PAUSE_UNTIL_PRESS}"); //"Turned off the Exp. Share.\pParty will no longer gain a portion\nof any Experience Points.{PAUSE_UNTIL_PRESS}"
const u8 gText_ItemfinderResponding[] = _("Huh?\nThe ITEMFINDERÙ\lresponding! ThereÙ\lan item buried\laround here!{PAUSE_UNTIL_PRESS}"); //"Huh?\nThe ITEMFINDER's responding!\pThere's an item buried around here!{PAUSE_UNTIL_PRESS}"
const u8 gText_ItemfinderShakingWildly[] = _("Oh!\nThe ITEMFINDERÙ\lshaking wildly!\lThereÙ an item\lburied underfoot!\n... ... ... ...{PAUSE_UNTIL_PRESS}"); //"Oh!\nThe ITEMFINDER's shaking wildly!\pThere's an item buried underfoot!\p‥ ‥ ‥ ‥ ‥ ‥{PAUSE_UNTIL_PRESS}"
const u8 gText_NopeTheresNoResponse[] = _("......Nope! ThereÙ\nno response.{PAUSE_UNTIL_PRESS}"); //"‥ ‥ ‥ ‥Nope!\nThere's no response.{PAUSE_UNTIL_PRESS}"
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild FRAGMON will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild FRAGMON will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayedPokeFluteCatchy[] = _("Played the\nPOKé FLUTE.\lNow, thatÙ a\lcatchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Played the\pPOKé FLUTE."); //"Played the POKé FLUTE."
const u8 gText_PokeFluteAwakenedMon[] = _("The POKé FLUTE awakened sleeping\nFRAGMON.{PAUSE_UNTIL_PRESS}"); //"The POKé FLUTE awakened sleeping\nPOKéMON.{PAUSE_UNTIL_PRESS}"
const u8 gText_TMCase[] = _("TM CASE");
const u8 gText_TMCaseType[] = _("TYPE");
const u8 gText_TMCasePower[] = _("POWER");
const u8 gText_TMCaseAccuracy[] = _("ACCURACY");
const u8 gText_TMCasePP[] = _("PP");
const u8 gText_Money[] = _("MONEY");
const u8 gText_Close[] = _("CLOSE");
const u8 gText_TMCaseWillBePutAway[] = _("The TM CASE\nwill be\nput away."); //"The TM CASE will be\nput away."
...
const u8 gText_Var1CertainlyHowMany[] = _("{STR_VAR_1}?\nHow many would you like?"); //"{STR_VAR_1}? Certainly.\nHow many would you like?"
const u8 gText_Var1AndYouWantedVar2[] = _("That will be\n¥{STR_VAR_3}. OK?"); //"{STR_VAR_1}, and you want {STR_VAR_2}.\nThat will be ¥{STR_VAR_3}. Okay?"
...
const u8 gText_YouDontHaveMoney[] = _("You donÑ have\nenough money.{PAUSE_UNTIL_PRESS}"); //You don't have enough money.{PAUSE_UNTIL_PRESS}"
const u8 gText_NoMoreRoomForThis[] = _("You donÑ have\nenough room.{PAUSE_UNTIL_PRESS}"); //"You have no more room for this\nitem.{PAUSE_UNTIL_PRESS}"
const u8 gText_SpaceForVar1Full[] = _("{STR_VAR_1}を\nいれる ばしょが いっぱいです{PAUSE_UNTIL_PRESS}");
const u8 gText_AnythingElseICanHelp[] = _("Is there anything\nelse I can do?");
...
const u8 gText_TurnedOverItemsWorthYen[] = _("Turned over the\n{STR_VAR_1}シSス worth ¥{STR_VAR_3}.");
...
const u8 gText_ItemEffect_SpDef[] = _("SPECIAL");
const u8 gText_PartyMenu_OK[] = _("OK");
const u8 gText_Empty[] = _("");
const u8 gText_PauseUntilPress[] = _("{PAUSE_UNTIL_PRESS}");
const u8 gText_WontHaveEffect[] = _("It wonÑ have any effect.{PAUSE_UNTIL_PRESS}"); //"It won't have any effect.{PAUSE_UNTIL_PRESS}"
const u8 gText_CantBeUsedOnPkmn[] = _("This canÑ be used on\nthat FRAGMON.{PAUSE_UNTIL_PRESS}"); //"This can't be used on\nthat POKéMON.{PAUSE_UNTIL_PRESS}"
const u8 gText_PkmnCantSwitchOut[] = _("{STR_VAR_1} canÑ be switched\nout!{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1} can't be switched\nout!{PAUSE_UNTIL_PRESS}"
...
const u8 gText_CantSwitchWithAlly[] = _("You canÑ switch {STR_VAR_1}Ù\nFRAGMON with one of yours!{PAUSE_UNTIL_PRESS}"); //"You can't switch {STR_VAR_1}'s\nPOKéMON with one of yours!{PAUSE_UNTIL_PRESS}"
const u8 gText_EggCantBattle[] = _("An EGG canÑ battle!{PAUSE_UNTIL_PRESS}"); //"An EGG can't battle!{PAUSE_UNTIL_PRESS}"
const u8 gText_CantUseUntilNewBadge[] = _("This canÑ be used until a\nnew BADGE is obtained.{PAUSE_UNTIL_PRESS}"); //"This can't be used until a new\nBADGE is obtained.{PAUSE_UNTIL_PRESS}"
const u8 gText_NoMoreThanThreeMayEnter[] = _("No more than three FRAGMON\nmay enter.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanTwoMayEnter[] = _("No more than two FRAGMON\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PCMailboxFull[] = _("Your PCÙ MAILBOX is full.{PAUSE_UNTIL_PRESS}"); //"Your PC's MAILBOX is full.{PAUSE_UNTIL_PRESS}"
...
const u8 gText_PkmnAlreadyHoldingItemSwitch[] = _("{STR_VAR_1} is already\nholding {STR_VAR_2}.\pWould you like to\nswitch the items?"); //"{STR_VAR_1} is already holding\none {STR_VAR_2}.\pWould you like to switch the\ntwo items?"
const u8 gText_PkmnNotHolding[] = _("{STR_VAR_1} isnÑ holding\nanything.{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1} isn't holding\nanything.{PAUSE_UNTIL_PRESS}"
const u8 gText_ReceivedItemFromPkmn[] = _("Received the {STR_VAR_2}\nfrom {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailTakenFromPkmn[] = _("MAIL was taken from the\nFRAGMON.{PAUSE_UNTIL_PRESS}");
const u8 gText_SwitchedPkmnItem[] = _("{STR_VAR_2} was taken and\nreplaced with {STR_VAR_1}.{PAUSE_UNTIL_PRESS}"); //"The {STR_VAR_2} was taken and\nreplaced with the {STR_VAR_1}.{PAUSE_UNTIL_PRESS}"
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("This FRAGMON is holding an\nitem. It cannot hold MAIL.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailTransferredFromMailbox[] = _("MAIL was transferred from\nthe MAILBOX.{PAUSE_UNTIL_PRESS}");
const u8 gText_BagFullCouldNotRemoveItem[] = _("The {STR_VAR_1} is full. The FRAGMONÙ\nitem could not be removed.{PAUSE_UNTIL_PRESS}"); //"The {STR_VAR_1} is full. The POKéMON's\nitem could not be removed.{PAUSE_UNTIL_PRESS}"
const u8 gText_PkmnLearnedMove3[] = _("{STR_VAR_1} learned\n{STR_VAR_2}!");
const u8 gText_PkmnCantLearnMove[] = _("{STR_VAR_1} and {STR_VAR_2}\nare not compatible.\p{STR_VAR_2} canÑ be\nlearned.{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1} and {STR_VAR_2}\nare not compatible.\p{STR_VAR_2} can't be\nlearned.{PAUSE_UNTIL_PRESS}"
const u8 gText_PkmnNeedsToReplaceMove[] = _("{STR_VAR_1} wants to learn\nthe move {STR_VAR_2}.\pHowever, {STR_VAR_1} already\nknows four moves.\pShould a move be deleted and\nreplaced with {STR_VAR_2}?"); //"{STR_VAR_1} wants to learn the\nmove {STR_VAR_2}.\pHowever, {STR_VAR_1} already\nknows four moves.\pShould a move be deleted and\nreplaced with {STR_VAR_2}?"
const u8 gText_StopLearningMove2[] = _("Stop trying to teach\n{STR_VAR_2}?");
const u8 gText_MoveNotLearned[] = _("{STR_VAR_1} did not learn\nthe move {STR_VAR_2}.{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1} did not learn the\nmove {STR_VAR_2}.{PAUSE_UNTIL_PRESS}"
const u8 gText_WhichMoveToForget[] = _("Which move should be\nforgotten?{PAUSE_UNTIL_PRESS}"); //"Which move should be forgotten?{PAUSE_UNTIL_PRESS}"
...
const u8 gText_PkmnHPRestoredByVar2[] = _("{STR_VAR_1}Ù HP was restored\nby {STR_VAR_2} point(s).{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1}'s HP was restored\nby {STR_VAR_2} point(s).{PAUSE_UNTIL_PRESS}"
...
const u8 gText_PkmnBurnHealed[] = _("{STR_VAR_1}Ù burn was healed.{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1}'s burn was healed.{PAUSE_UNTIL_PRESS}"
...
const u8 gText_MovesPPIncreased[] = _("{STR_VAR_1}Ù PP increased.{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1}'s PP increased.{PAUSE_UNTIL_PRESS}"
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} was elevated to\nLv. {STR_VAR_2}.");
const u8 gText_PkmnBaseVar2StatIncreased[] = _("{STR_VAR_1}Ù base {STR_VAR_2}\nstat was raised.{PAUSE_UNTIL_PRESS}"); //"{STR_VAR_1}'s base {STR_VAR_2}\nstat was raised.{PAUSE_UNTIL_PRESS}"
...
const u8 gText_OnlyPkmnForBattle[] = _("ThatÙ your only\nFRAGMON for battle."); //"That's your only\nPOKéMON for battle."
const u8 gText_SummaryScreenNo[] = _("No. /");
const u8 gText_SummaryScreenType[] = _("TYPE/");
const u8 gText_SummaryScreenOT[] = _("OT  /");
const u8 gText_SummaryScreenIDNo[] = _("IDNo/");
const u8 gText_SummaryScreenITEM[] = _("ITEM/");
const u8 gText_SummaryScreenHP[] = _("HP");
const u8 gText_SummaryScreenATTACK[] = _("ATTACK /");
const u8 gText_SummaryScreenDEFENSE[] = _("DEFENSE/");
const u8 gText_SummaryScreenSPECIAL[] = _("SPECIAL/");
const u8 gText_SummaryScreenSPEED[] = _("SPEED  /");
const u8 gText_SummaryScreenPOWER[] = _("POWER   /");
const u8 gText_SummaryScreenACCURACY[] = _("ACCURACY/");
const u8 gText_SummaryScreenEFFECT[] = _("EFFECT  /");
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That FRAGMON canÑ be traded\nnow."); //"That POKéMON can't be traded\nnow."
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG canÑ be traded now."); //"An EGG can't be traded now."
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINERÙ FRAGMON\ncanÑ be traded now."); //"The other TRAINER's POKéMON\ncan't be traded now."
ALIGNED(4) const u8 gText_OtherTrainerCantAcceptPkmn[] = _("The other TRAINER canÑ accept\nthat FRAGMON now."); //"The other TRAINER can't accept\nthat POKéMON now."
ALIGNED(4) const u8 gText_CantTradeWithTrainer[] = _("You canÑ trade with that\nTRAINER now."); //"You can't trade with that\nTRAINER now."
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isnÑ the type of FRAGMON\nthat the other TRAINER wants."); //"That isn't the type of POKéMON\nthat the other TRAINER wants."
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("That isnÑ an EGG."); //"That isn't an EGG."
const u8 gText_ChoosePokemon[] = _("Choose a FRAGMON.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which FRAGMON?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which FRAGMON?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which FRAGMON?");
const u8 gText_DoWhatWithPokemon[] = _("Do what?"); //"Do what with this {PKMN}?"
const u8 gText_NothingToCut[] = _("Nothing to CUT..."); //"There's nothing to CUT."
const u8 gText_CantSurfHere[] = _("No SURFING here!");
const u8 gText_AlreadySurfing[] = _("Youàe already SURFING."); //"You're already SURFING."
const u8 gText_CantUseHere[] = _("CanÑ use that here."); //"Can't use that here."
const u8 gText_RestoreWhichMove[] = _("Which move?"); //"Restore which move?"
const u8 gText_BoostPp[] = _("Which move?"); //"Boost PP of which?"
const u8 gText_DoWhatWithItem[] = _("Do what?"); //"Do what with an item?"
const u8 gText_NoPokemonForBattle[] = _("No battling this way!");
const u8 gText_ChoosePokemon2[] = _("Choose a FRAGMON.");
const u8 gText_NotEnoughHp[] = _("Not enough HP..."); //"Not enough HP‥"
const u8 gText_ThreePkmnAreNeeded[] = _("Three {PKMN} are needed.");
const u8 gText_PokemonCantBeSame[] = _("{PKMN} canÑ be the same."); //"{PKMN} can't be the same."
...
const u8 gText_ChoosePokemonCancel[] = _("Choose FRAGMON."); //"Choose POKéMON or CANCEL."
const u8 gText_ChoosePokemonConfirm[] = _("Choose FRAGMON."); //"Choose POKéMON and confirm."
const u8 gText_TwoPokemonAreNeeded[] = _("Two FRAGMON are needed.");
const u8 gText_EnjoyCycling[] = _("LetÙ enjoy cycling!"); //"Let's enjoy cycling!"
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("OAK: ItÙ important to get to know\nyour FRAGMON thoroughly.\p"); //"OAK: It's important to get to know\nyour POKéMON thoroughly.\p"
const u8 gText_OakThisIsListOfPokemon[] = _("This is a list of your FRAGMON,\n{PLAYER}.\pOpen this to check the skills\nand moves of your FRAGMON.\pYou also choose FRAGMON here if\nyou want to use an item on one.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_LureWildPokemon[] = _("Lure wild FRAGMON.");
const u8 gText_ShareHp[] = _("Share HP.");
const u8 gText_ReturnToAHealingSpot[] = _("Return to a healing spot.");
const u8 gText_EscapeFromHereAndReturnTo[] = _("Want to return to\n{STR_VAR_1}?"); //"Want to escape from here and return\nto {STR_VAR_1}?"
const u8 gText_ReturnToHealingSpot[] = _("Warp to the last\nPOKéMON CENTER?"); //"Want to return to the healing spot\nused last in {STR_VAR_1}?""
...
const u8 gText_PkmnCantParticipate[] = _("That FRAGMON canÑ participate.{PAUSE_UNTIL_PRESS}"); //"That POKéMON can't participate.{PAUSE_UNTIL_PRESS}"
...
const u8 gText_StoreItemsInThePC[] = _("Store items in\nthe PC.");
const u8 gText_TakeOutItemsFromThePC[] = _("Take out items\nfrom the PC.");
const u8 gText_ThrowAwayItemsInPC[] = _("パソコンに あずけている\nどうぐを すてます");
const u8 gText_ThereAreNoItems[] = _("There are no\nitems.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TheresNoMailHere[] = _("ThereÙ no MAIL here.{PAUSE_UNTIL_PRESS}"); //"There's no MAIL here.{PAUSE_UNTIL_PRESS}"
const u8 gText_WhatWouldYouLikeToDoWithPlayersMail[] = _("What would you like to do with\n{STR_VAR_1}Ù MAIL?"); //"What would you like to do with\n{STR_VAR_1}'s MAIL?"
...
const u8 gText_WithdrawItem[] = _("WITHDRAW"); //"WITHDRAW\nITEM"
const u8 gText_Withdraw[] = _("TAKE");
...
const u8 gText_StopReading[] = _("STOP READING");
...
const u8 gText_FreshWater_200[] = _("FRESH WATER ¥200"); //"FRESH WATER{CLEAR_TO 0x57}{FONT_SMALL}¥200"
const u8 gText_SodaPop_300[] = _("SODA POP    ¥300"); //"SODA POP{CLEAR_TO 0x57}{FONT_SMALL}¥300"
const u8 gText_Lemonade_350[] = _("LEMONADE    ¥350"); //"LEMONADE{CLEAR_TO 0x57}{FONT_SMALL}¥350"
const u8 gText_50Coins_1000[] = _("50 COIN  ¥1,000"); //"{FONT_SMALL} 50 COINS{CLEAR_TO 0x45}¥1,000"
const u8 gText_500Coins_10000[] = _("500 COIN ¥10,000"); //"{FONT_SMALL}500 COINS{CLEAR_TO 0x40}¥10,000"
...
const u8 gText_Tm23_3300Coins[] = _("TM23 3,300 COIN");
const u8 gText_Tm15_5500Coins[] = _("TM15 5,500 COIN");
const u8 gText_Tm50_7700Coins[] = _("TM50 7,700 COIN");
...
const u8 gText_BillSPc[] = _("BILLÙ PC");
const u8 gText_SPc[] = _("{PLAYER}Ù PC");
const u8 gText_HallOfFame_2[] = _("HALL OF FAME");
const u8 gText_LogOff[] = _("LOG OFF");
const u8 gText_ProfOakSPc[] = _("PROF.OAKÙ PC");
...
const u8 gText_Coins_2[] = _("COIN");
const u8 gText_Bicycle_Price[] = _("BICYCLE{CLEAR_TO 0x49}{FONT_SMALL}¥1,000,000");
const u8 gText_NoThanks[] = _("NO THANKS");
const u8 gText_Abra_120Coins[] = _("ABRA 120 COIN");
const u8 gText_Abra_180Coins[] = _("ABRA 180 COIN");
const u8 gText_Clefairy_500Coins[] = _("CLEFAIRY 500 COIN");
const u8 gText_Clefairy_750Coins[] = _("CLEFAIRY 750 COIN");
const u8 gText_Dratini_4600Coins[] = _("DRATINI 4,600 COIN");
const u8 gText_Dratini_2800Coins[] = _("DRATINI 2,800 COIN");
const u8 gText_Nidorino_1200Coins[] = _("NIDORINO 1,200 COIN");
const u8 gText_Nidorina_1200Coins[] = _("NIDORINA 1,200 COIN");
const u8 gText_Porygon_6500Coins[] = _("PORYGON 6,500 COIN");
const u8 gText_Porygon_9999Coins[] = _("PORYGON 9,999 COIN");
const u8 gText_Pinsir_2500Coins[] = _("PINSIR 2,500 COIN");
const u8 gText_Scyther_5500Coins[] = _("SCYTHER 2,500 COIN");
...
const u8 gText_PokemonJump[] = _("FRAGMON JUMP");
...
const u8 gText_HowToLink[] = _("HOW TO LINK");
...
const u8 gString_BattleRecords_PlayersBattleResults[] = _("{PLAYER}Ù BATTLE RESULTS"); //"{PLAYER}'s BATTLE RESULTS"
...
const u8 gText_WhatDoYouWantToDo[] = _("What do you want\nto do?"); //"What do you want to do?"
...
const u8 gText_ReleaseThisPokemon[] = _("Release this FRAGMON?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0x00} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0x00}!");
const u8 gText_MarkYourPkmn[] = _("Mark your FRAGMON.");
const u8 gText_ThatsYourLastPkmn[] = _("ThatÙ your last FRAGMON!"); //"That's your last POKéMON!"
const u8 gText_YourPartysFull[] = _("Your partyÙ full!"); //"Your party's full!"
const u8 gText_YoureHoldingAPkmn[] = _("Youàe holding a FRAGMON!"); //"You're holding a POKéMON!"
const u8 gText_WhichOneWillYouTake[] = _("Which one will you take?");
const u8 gText_YouCantReleaseAnEgg[] = _("You canÑ release an EGG."); //"You can't release an EGG."
const u8 gText_ContinueBoxOperations[] = _("Continue operations?"); //"Continue BOX operations?"
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a FRAGMON?");
...
const u8 gText_MailCantBeStored[] = _("MAIL canÑ be stored!"); //"MAIL can't be stored!"
...
const u8 gPCText_Scenery1[] = _("COLORS 1");
const u8 gPCText_Scenery2[] = _("COLORS 2");
const u8 gPCText_Scenery3[] = _("COLORS 3");
const u8 gPCText_Etcetera[] = _("COLORS 4");
const u8 gPCText_Forest[] = _("GREEN");
const u8 gPCText_City[] = _("RED");
const u8 gPCText_Desert[] = _("BLUE");
const u8 gPCText_Savanna[] = _("YELLOW");
const u8 gPCText_Crag[] = _("PURPLE");
const u8 gPCText_Volcano[] = _("PINK");
const u8 gPCText_Snow[] = _("ORANGE");
const u8 gPCText_Cave[] = _("TEAL");
const u8 gPCText_Beach[] = _("BROWN");
const u8 gPCText_Seafloor[] = _("DARK GRAY");
const u8 gPCText_River[] = _("LIGHT GRAY");
const u8 gPCText_Sky[] = _("WHITE");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW FRAGMON");
const u8 gText_DepositPokemon[] = _("DEPOSIT FRAGMON");
const u8 gText_MovePokemon[] = _("MOVE FRAGMON");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Withdraw FRAGMON\nfrom a BOX."); //"You can withdraw\na POKéMON if you\nhave any in a BOX."
const u8 gText_DepositMonDescription[] = _("Deposit FRAGMON\nin a BOX."); //"You can deposit\nyour party\nPOKéMON in any BOX."
const u8 gText_MoveMonDescription[] = _("Move FRAGMON that\nare in a BOX."); //"You can move POKéMON that are\nstored in any BOX."
const u8 gText_MoveItemsDescription[] = _("Move items held\nby FRAGMON."); //"Move items held by BOX\n or party POKéMON."
const u8 gText_SeeYaDescription[] = _("See you later!");
const u8 gText_JustOnePkmn[] = _("CanÑ deposit the last FRAGMON!"); //"Can't deposit the last POKéMON!"
const u8 gText_PartyFull[] = _("CanÑ take any more\nFRAGMON."); //"Can't take any more POKéMON."
...
const u8 gText_AndImproveTheBardsSong[] = _("and improve the BARDÙ song."); //"and improve the BARD's song."
const u8 gText_AndFillOutTheQuestionnaire[] = _("and fill out the questionnaire.");
const u8 gText_YourProfile[] = _("Your profile");
const u8 gText_YourFeelingAtTheBattlesStart[] = _("Your feeling at the battleÙ start"); //"Your feeling at the battle's start"
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the FRAGMON MAIL?");
...
const u8 gText_AtTheBattlesStart[] = _("At the battleÙ start:"); //"At the battle's start:"
const u8 gText_UponWinningABattle[] = _("Upon winning a battle:");
const u8 gText_UponLosingABattle[] = _("Upon losing a battle:");
const u8 gText_TheBardsSong[] = _("The BARDÙ Song"); //"The BARD's Song"
const u8 gText_WhatsHipAndHappening[] = _("WhatÙ hip and happening?"); //"What's hip and happening?"
...
const u8 gText_PokemonCenter[] = _("FRAGMON CENTER");
...
const u8 gText_PkmnsNickname[] = _("Ù name?"); //"'s nickname?" - Temporarily shortened
const u8 gText_RivalsName[] = _("RIVALÙ NAME?"); //"RIVAL's NAME?"
...
const u8 gText_RegionMap_AreaDesc_ViridianForest[] = _("A sprawling forest that\nextends around VIRIDIAN\nCITY. A natural maze,\nmany people become lost\ninside."); //"A deep and sprawling forest that\nextends around VIRIDIAN CITY.\nA natural maze, many people\nbecome lost inside."
const u8 gText_RegionMap_AreaDesc_MtMoon[] = _("A mystical mountain\nknown for frequent\nmeteor falls. The shards\nof stars that fall here\nare known as MOON STONES."); //"A mystical mountain that is known\nfor its frequent meteor falls.\nThe shards of stars that fall\nhere are known as MOON STONES."
const u8 gText_RegionMap_AreaDesc_DiglettsCave[] = _("A seemingly plain tunnel\nthat was dug by wild\nDIGLETT. It is famous\nfor connecting ROUTES 2\nand 11."); //"A seemingly plain tunnel that was\ndug by wild DIGLETT.\nIt is famous for connecting\nROUTES 2 and 11."
const u8 gText_RegionMap_AreaDesc_VictoryRoad[] = _("A tunnel situated on\nROUTE 23. It earned its\nname because it must be\ntraveled by all TRAINERS\naiming for the top."); //"A tunnel situated on ROUTE 23.\nIt earned its name because it\nmust be traveled by all TRAINERS\naiming for the top."
const u8 gText_RegionMap_AreaDesc_PokemonMansion[] = _("A decrepit, burned-down\nmansion on CINNABAR\nISLAND. It got its name\nbecause a famous FRAGMON\nresearcher lived there."); //"A decrepit, burned-down mansion\non CINNABAR ISLAND.\nIt got its name because a famous\nPOKéMON researcher lived there."
const u8 gText_RegionMap_AreaDesc_SafariZone[] = _("An amusement park\noutside FUCHSIA CITY\nwhere many rare FRAGMON\ncan be observed in the\nwild and caught."); //"An amusement park outside FUCHSIA\nCITY where many rare POKéMON can\nbe observed in the wild.\nCatch them in a popular game!"
const u8 gText_RegionMap_AreaDesc_RockTunnel[] = _("A naturally formed\nunderground tunnel.\nBecause it has not been\ndeveloped, it is inky\ndark inside."); //"A naturally formed underground\ntunnel. Because it has not been\ndeveloped, it is inky dark inside.\nA light is needed to get through."
const u8 gText_RegionMap_AreaDesc_SeafoamIslands[] = _("A pair of islands that\nis situated on ROUTE 20.\nThe two islands are\nshaped the same, as if\nthey were twins."); //"A pair of islands that is situated\non ROUTE 20.\nThe two islands are shaped the\nsame, as if they were twins."
const u8 gText_RegionMap_AreaDesc_PokemonTower[] = _("A tower that houses the\ngraves of countless\nFRAGMON. Many people\nvisit it daily to pay\ntheir respects."); //"A tower that houses the graves of\ncountless POKéMON.\nMany people visit it daily to pay\ntheir respects to the fallen."
const u8 gText_RegionMap_AreaDesc_CeruleanCave[] = _("A mysterious cave that\nis filled with terribly\ntough FRAGMON. The\nFRAGMON LEAGUE is in\ncharge of it."); //"A mysterious cave that is filled\nwith terribly tough POKéMON.\nIt is so dangerous, the POKéMON\nLEAGUE is in charge of it."
const u8 gText_RegionMap_AreaDesc_PowerPlant[] = _("A power plant that was\nabandoned years ago. It\nis infested with\nelectric FRAGMON."); //"A power plant that was abandoned\nyears ago, though some of the\nmachines still work. It is infested\nwith electric POKéMON."
const u8 gText_RegionMap_AreaDesc_MtEmber[] = _("Supposedly an inactive\nvolcano. However, there\nare persistent reports\nthat the peak blazes\nwith fire at night."); //"Supposedly an inactive volcano.\nHowever, there are persistent\nreports that the peak blazes\nwith fire at night."
const u8 gText_RegionMap_AreaDesc_BerryForest[] = _("A forest on a small islet off the\ncoast of THREE ISLAND. BERRIES\ngrow wildly in profusion, quickly\nreplenishing those that fall off."); //"A forest on a small islet off the\ncoast of THREE ISLAND. BERRIES\ngrow wildly in profusion, quickly\nreplenishing those that fall off."
const u8 gText_RegionMap_AreaDesc_IcefallCave[] = _("A cave which is covered by water\nand ice on FOUR ISLAND.\nIt seems like the end of the cave\nis connected to the ocean."); //"A cave which is covered by water\nand ice on FOUR ISLAND.\nIt seems like the end of the cave\nis connected to the ocean."
const u8 gText_RegionMap_AreaDesc_LostCave[] = _("A bewildering cave off the coast\nof RESORT GORGEOUS.\nSome curious thrill seekers have\nnever emerged from it."); //"A bewildering cave off the coast\nof RESORT GORGEOUS.\nSome curious thrill seekers have\nnever emerged from it."
const u8 gText_RegionMap_AreaDesc_TanobyRuins[] = _("An ancient ruin that is rumored to\nbe home to a peculiar FRAGMON.\nHowever, so far, the FRAGMON\nremains an unconfirmed rumor."); //"An ancient ruin that is rumored to\nbe home to a peculiar POKéMON.\nHowever, so far, the POKéMON\nremains an unconfirmed rumor."
const u8 gText_RegionMap_AreaDesc_AlteringCave[] = _("This island has been known by this\nname since the distant past.\nNo one today knows where it got\nthis name, however."); //"This island has been known by this\nname since the distant past.\nNo one today knows where it got\nthis name, however."
const u8 gText_RegionMap_AreaDesc_PatternBush[] = _("A lush and bush-like area. \nIn it are patterns where no grass\ngrows. Some study it in the belief\nthat a secret is concealed."); //"A lush and bush-like area. \nIn it are patterns where no grass\ngrows. Some study it in the belief\nthat a secret is concealed."
const u8 gText_RegionMap_AreaDesc_DottedHole[] = _("A mysterious, just-discovered\nruin from an ancient time.\nIt got its name from the six dots\non its door."); //"A mysterious, just-discovered\nruin from an ancient time.\nIt got its name from the six dots\non its door."
...
const u8 gText_PokeSum_EggOrigin_DayCare[] = _("An odd FRAGMON EGG found by the\nDAY-CARE couple.");
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("An odd FRAGMON EGG obtained from\nthe traveling man.");
const u8 gText_PokeSum_EggOrigin_NicePlace[] = _("A wondrously peculiar FRAGMON EGG\nobtained at a nice place.");
const u8 gText_PokeSum_EggOrigin_Spa[] = _("An odd FRAGMON EGG obtained from\nan old woman at the SPA.");
const u8 gText_PokeSum_EggOrigin_Trade[] = _("A peculiar FRAGMON EGG\nobtained in a trade."); //"A peculiar POKéMON EGG obtained\nin a trade."
...
const u8 gText_PokeSum_EggHatch_AlmostReady[] = _("ItÙ making sounds.\nItÙ almost ready\nto hatch!"); //"It's making sounds.\nIt's almost ready\nto hatch!"
const u8 gText_PokeSum_ATrade[] = _("a trade");
const u8 gText_Somewhere[] = _("Somewhere");
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("INFO"); //"POKéMON INFO"
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("SKILLS"); //"POKéMON SKILLS"
const u8 gText_PokeSum_PageName_KnownMoves[] = _("MOVES"); //"KNOWN MOVES"
...
const u8 gText_PokeSum_HmMovesCantBeForgotten[] = _("HM moves canÑ be\nforgotten now."); //"HM moves can't be\nforgotten now."
const u8 gText_TrainerCardName[] = _("NAME/"); //"NAME: "
const u8 gText_TrainerCardIDNo[] = _("No."); //"IDNo."
const u8 gText_TrainerCardMoney[] = _("MONEY/"); //"MONEY"
const u8 gText_TrainerCardYen[] = _("¥");
const u8 gText_TrainerCardPokedex[] = _("ARTBOOK/"); //"POKéDEX"
const u8 gText_TrainerCardNull[] = _("");
const u8 gText_Colon2[] = _(":");
const u8 gText_Points[] = _("てん");
const u8 gText_TrainerCardTime[] = _("TIME/"); //"TIME"
const u8 gText_BattlePoints[] = _("ゲ-ムポイント"); // Unused. Name presumed, translation is Game Points
const u8 gText_Var1sTrainerCard[] = _("Ù TRAINER CARD"); //"'s TRAINER CARD"
...
const u8 gText_PokemonTrades[] = _("FRAGMON TRADES");
const u8 gText_UnionRoomTradesBattles[] = _("UNION TRADES"); //"UNION TRADES & BATTLES"
...
const u8 gText_SavingDontTurnOffThePower2[] = _("Now Saving..."); //"SAVING…\nDON'T TURN OFF THE POWER."

// Start menu option descriptions
const u8 gStartMenuDesc_Pokedex[] = _("A device that records FRAGMON secrets\nupon meeting or catching them.");
const u8 gStartMenuDesc_Pokemon[] = _("Check and organize FRAGMON that are\ntraveling with you in your party.");
...
const u8 gText_LevelRoseTo[] = _("Ù level rose to\n"); //"'s level rose to\n"
const u8 gText_Period2[] = _(".");
const u8 gText_LevelUp_MaxHP[] = _("MAX HP");
...
const u8 gText_LevelUp_SpDef[] = _("SPECIAL");
...
const u8 gText_ExitingTheChat[] = _("Exiting the chat..."); //"Exiting the chat‥"
...
const u8 gText_RegisteredTextChanged_SavingDontTurnOff[] = _("SAVING... DON'T\nTURN OFF THE POWER."); //"SAVING…\nDON'T TURN OFF THE POWER."
...
const u8 gText_Pokemon2[] = _("FRAGMON");
...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a FRAGMON CENTER,\nprotecting the exhausted and fainted\nFRAGMON from further harm...\p"); //"{PLAYER} scurried to a POKéMON CENTER,\nprotecting the exhausted and fainted\nPOKéMON from further harm‥\p"
const u8 gText_PlayerScurriedBackHome[] = _("{PLAYER} scurried back home, protecting\nthe exhausted and fainted FRAGMON from\nfurther harm...\p"); //"{PLAYER} scurried back home, protecting\nthe exhausted and fainted POKéMON from\nfurther harm‥\p"
const u8 gText_Diploma_Player[] = _("PLAYER {DYNAMIC 0x00}");
const u8 gText_Diploma_ThisDocument[] = _("Congrats! This\ndiploma certifies\nthat you have\ncompleted your\nARTBOOK."); //"Congrats! This diploma certifies\nthat you have completed\nyour POKéDEX."
...
const u8 gText_ClearingData[] = _("Clearing data...\nPlease wait."); //"Clearing data‥\nPlease wait."
const u8 gText_Player[] = _("PLAYER");
const u8 gText_Time[] = _("TIME");
const u8 gText_Colon[] = _(":");
const u8 gText_Pokedex[] = _("ARTBOOK");
const u8 gTextJPDummy_Hiki[] = _("");
const u8 gText_Badges[] = _("BADGES");
const u8 gTextJPDummy_Ko[] = _("");
const u8 gText_Register[] = _("REGISTER");
const u8 gText_HatchedFromEgg[] = _("{STR_VAR_1} hatched from\nthe EGG!"); //"{STR_VAR_1} hatched from the EGG!"
const u8 gText_NickHatchPrompt[] = _("Would you like to\nnickname the newly\lhatched {STR_VAR_1}?"); //"Would you like to nickname the newly\nhatched {STR_VAR_1}?"
const u8 gString_OutOfCoins[] = _("You donÑ have\nany coins!");
...
const u8 gText_PkmnJumpRecords[] = _("FRAGMON JUMP RECORDS");
...
const u8 gText_FilledStorageSpace2[] = _("ThereÙ no room left now."); //"There's no room left now."
const u8 gText_CantHoldMore[] = _("You canÑ hold any more!"); //"You can't hold any more!"
...
const u8 gText_SavingDontTurnOffPower[] = _("Now Saving..."); //"SAVING…\nDON'T TURN OFF THE POWER."
...
const u8 gText_CantHoldAnyMore[] = _("You canÑ hold any more..."); //"You can't hold any more..."
...
const u8 gText_PokemonOnHook[] = _("A FRAGMONÙ on the\nhook!{PAUSE_UNTIL_PRESS}"); //"A POKéMON's on the hook!{PAUSE_UNTIL_PRESS}"
const u8 gText_NotEvenANibble[] = _("Not even a\nnibble...{PAUSE_UNTIL_PRESS}"); //"Not even a nibble‥{PAUSE_UNTIL_PRESS}"
const u8 gText_ItGotAway[] = _("It got away...{PAUSE_UNTIL_PRESS}"); //"It got away‥{PAUSE_UNTIL_PRESS}"
const u8 gText_Rooftop2[] = _("ROOFTOP");

ALIGNED(4) const u8 gString_PokemonRed_Staff[] = _("     POKéMON\nRED VERSION STAFF\n");
ALIGNED(4) const u8 gString_PokemonBlue_Staff[] = _("     POKéMON\nBLUE VERSION STAFF\n");
ALIGNED(4) const u8 gCreditsString_Director[] = _("\n     DIRECTOR\n");
ALIGNED(4) const u8 gCreditsString_Programmers[] = _("\n    PROGRAMMERS\n");
ALIGNED(4) const u8 gCreditsString_CharacterDesign[] = _("\n  CHARACTER DESIGN\n");
ALIGNED(4) const u8 gCreditsString_Music[] = _("\n       MUSIC\n");
ALIGNED(4) const u8 gCreditsString_Sound_Effects[] = _("\n   SOUND EFFECTS\n");
ALIGNED(4) const u8 gCreditsString_Game_Design[] = _("\n    GAME DESIGN\n");
ALIGNED(4) const u8 gCreditsString_Monster_Design[] = _("\n  MONSTER DESIGN\n");
ALIGNED(4) const u8 gCreditsString_Game_Scenario[] = _("\n   GAME SCENARIO\n");
ALIGNED(4) const u8 gCreditsString_Parametric_Design[] = _("\nPARAMETRIC DESIGN\n");
ALIGNED(4) const u8 gCreditsString_Map_Design[] = _("\n    MAP DESIGN\n");
ALIGNED(4) const u8 gCreditsString_Product_Testing[] = _("\n PRODUCT TESTING\n");
ALIGNED(4) const u8 gCreditsString_Special_Thanks[] = _("\n   SPECIAL THANKS\n");
ALIGNED(4) const u8 gCreditsString_Producers[] = _("\n    PRODUCERS\n");
ALIGNED(4) const u8 gCreditsString_US_Version_Staff[] = _("\n US VERSION STAFF\n");
ALIGNED(4) const u8 gCreditsString_US_Coordination[] = _("\n  US COORDINATION\n");
ALIGNED(4) const u8 gCreditsString_Text_Translation[] = _("\n TEXT TRANSLATION\n");
ALIGNED(4) const u8 gCreditsString_Producer[] = _("\n   PRODUCER\n");
ALIGNED(4) const u8 gCreditsString_Executive_Producer[] = _("\nEXECUTIVE PRODUCER\n");

ALIGNED(4) const u8 gCreditsString_Satoshi_Tajiri[] = _("\n\n SATOSHI TAJIRI\n");
ALIGNED(4) const u8 gCreditsString_Takenori_Oota_Shigeki_Morimoto[] = _("\n\n  TAKENORI OOTA\n SHIGEKI MORIMOTO\n");
ALIGNED(4) const u8 gCreditsString_Tetsuya_Watanabe_Junichi_Masuda_Sousuke_Tamada[] = _("\n\n TETSUYA WATANABE\n  JUNICHI MASUDA\n  SOUSUKE TAMADA\n");
ALIGNED(4) const u8 gCreditsString_Ken_Sugimori_Atsuko_Nishida[] = _("\n\n   KEN SUGIMORI\n  ATSUKO NISHIDA\n\n");
ALIGNED(4) const u8 gCreditsString_Junichi_Masuda[] = _("\n\n  JUNICHI MASUDA\n");
ALIGNED(4) const u8 gCreditsString_Ken_Sugimori_Atsuko_Nishida_Motofumo_Fuziwara[] = _("\n\n   KEN SUGIMORI\n  ATSUKO NISHIDA\n MOTOFUMI FUZIWARA\n");
ALIGNED(4) const u8 gCreditsString_Shigeki_Morimoto_Satoshi_Oota_Rena_Yoshikawa[] = _("\n\n SHIGEKI MORIMOTO\n   SATOSHI OOTA\n  RENA YOSHIKAWA\n");
ALIGNED(4) const u8 gCreditsString_Ryohsuke_Taniguchi_Fumihiro_Nonomura_Hiroyuki_Zinnai[] = _("\n\nRYOHSUKE TANIGUCHI\nFUMIHIRO NONOMURA\n HIROYUKI ZINNAI\n");
ALIGNED(4) const u8 gCreditsString_Kohji_Nisino_Takeo_Nakamura[] = _("\n\n  KOHJI NISINO\n TAKEO NAKAMURA\n");
ALIGNED(4) const u8 gCreditsString_Satoshi_Tajiri_Kohji_Nisino[] = _("\n\n  SATOSHI TAJIRI\n   KOHJI NISINO\n");
ALIGNED(4) const u8 gCreditsString_Akiyoshi_Kakei_Kazuki_Tsuchiya[] = _("\n\n AKIYOSHI KAKEI\nKAZUKI TSUCHIYA\n");
ALIGNED(4) const u8 gCreditsString_Takeo_Nakamura_Masamitsu_Yuda[] = _("\n\n TAKEO NAKAMURA\n MASAMITU YUDA\n");
ALIGNED(4) const u8 gCreditsString_Tatsuya_Hishida_Yasuhiro_Sakai[] = _("\n\n TATSUYA HISHIDA\n  YASUHIRO SAKAI\n");
ALIGNED(4) const u8 gCreditsString_Wataru_Yamaguchi_Kazuyuki_Yamamoto[] = _("\n\n WATARU YAMAGUCHI\nKAZUYUKI YAMAMOTO\n");
ALIGNED(4) const u8 gCreditsString_Akihito_Tomisawa_Hiroyoshi_Kawamoto_Tomomichi_Oota[] = _("\n\n AKIHITO TOMISAWA\n HIROYOSHI KAWAMOTO\n  TOMOMICHI OOTA\n");
ALIGNED(4) const u8 gCreditsString_Shigeru_Miyamoto[] = _("\n\nSHIGERU MIYAMOTO\n");
ALIGNED(4) const u8 gCreditsString_Takashi_Kawaguchi[] = _("\n\nTAKASHI KAWAGUCHI\n");
ALIGNED(4) const u8 gCreditsString_Tsunekazu_Ishihara[] = _("\n\nTSUNEKAZU ISHIHARA\n");
ALIGNED(4) const u8 gCreditsString_Gail_Tilden[] = _("\n\n   GAIL TILDEN\n");
ALIGNED(4) const u8 gCreditsString_Naoko_Kawakami_Hiro_Nakamura[] = _("\n\n  NAOKO KAWAKAMI\n  HIRO NAKAMURA\n");
ALIGNED(4) const u8 gCreditsString_William_Giese_Sara_Osborne[] = _("\n\n  WILLIAM GIESE\n   SARA OSBORNE\n");
ALIGNED(4) const u8 gCreditsString_Nob_Ogasawara[] = _("\n\n  NOB OGASAWARA\n");
ALIGNED(4) const u8 gCreditsString_Teruki_Murakawa_Kohta_Fukui[] = _("\n\n TERUKI MURAKAWA\n   KOHTA FUKUI\n");
ALIGNED(4) const u8 gCreditsString_Satoru_Iwata[] = _("\n\n   SATORU IWATA\n");
ALIGNED(4) const u8 gCreditsString_Takahiro_Harada[] = _("\n\n TAKAHIRO HARADA\n");
ALIGNED(4) const u8 gCreditsString_Paad_Testing_NCL_Super_Mario_Club[] = _("\n\n   PAAD TESTING\nNCL SUPER MARIO CLUB\n");
ALIGNED(4) const u8 gCreditsString_Takehiro_Izushi[] = _("\n\n TAKEHIRO IZUSHI\n");
ALIGNED(4) const u8 gCreditsString_Hiroshi_Yamauchi[] = _("\n\n HIROSHI YAMAUCHI\n");
ALIGNED(4) const u8 gCreditsString_Kenji_Matsusima_Fumihiro_Nonomura_Ryohsuke_Taniguchi[] = _("\n\n KENJI MATSUSIMA\nFUMIHIRO NONOMURA\nRYOHSUKA TANIGUCHI\n");
...
const u8 gText_CommErrorCheckConnections[] = _("Communication error... Please\ncheck all connections, then\nturn the power OFF and ON."); //"Communication error…\nPlease check all connections,\nthen turn the power OFF and ON."
const u8 gText_CommErrorEllipsis[] = _("Communication error..."); //"Communication error…"
...
const u8 gEasyChatGroupName_Pokemon[] = _("FRAGMON");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("FRAGMON2");
...
const u8 gTradeText_ChooseAPokemon[] = _("Choose a FRAGMON.");
...
const u8 gText_Trade_CommunicationStandby[] = _("Communicating,\nplease wait!"); //"{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Communication standby…\nPlease wait."
const u8 gText_TradeHasBeenCanceled[] = _("The trade has been\ncanceled."); //"{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}The trade has been canceled."
const u8 gText_Trade_OnlyPkmnForBattle[] = _("ThatÙ your only\nFRAGMON for battle."); //"{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}That's your only POKéMON\nfor battle."
const u8 gText_WaitingForFriendToFinish[] = _("Waiting for\nyour friend..."); //"{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Waiting for your friend\nto finish…"
...
const u8 gText_XSentOverY[] = _("{STR_VAR_1} sent over\n{STR_VAR_3}.");
const u8 gText_TakeGoodCareOfX[] = _("Take good care of\n{STR_VAR_3}!");
...
const u8 gDaycareText_DontLikeOther[] = _("The two donÑ seem to like\neach other much."); //"The two don't seem to like\neach other much."
const u8 gDaycareText_PlayOther[] = _("The two prefer to play with other\nFRAGMON than each other.");
...
const u8 gText_MonIsTryingToLearnMove[] = _("{STR_VAR_1} is trying to learn\n{STR_VAR_2}.\pBut {STR_VAR_1} canÑ learn more\nthan four moves.\pDelete an older move to make\nroom for {STR_VAR_2}?"); //"{STR_VAR_1} is trying to learn\n{STR_VAR_2}.\pBut {STR_VAR_1} can't learn more\nthan four moves.\pDelete an older move to make\nroom for {STR_VAR_2}?"
const u8 gText_StopLearningMove[] = _("Stop learning {STR_VAR_2}?");
const u8 gText_1_2_and_Poof[] = _("{PAUSE 0x20}1, {PAUSE 0x0F}2, and {PAUSE 0x0F}... {PAUSE 0x0F}... {PAUSE 0x0F}... {PAUSE 0x0F}{PLAY_SE SE_BALL_BOUNCE_1}\nPoof!\p"); //"{PAUSE 0x20}1, {PAUSE 0x0F}2, and {PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p"
const u8 gText_MonForgotOldMoveAndMonLearnedNewMove[] = _("{STR_VAR_1} forgot {STR_VAR_3}.\pAnd...\p{STR_VAR_1}\nlearned {STR_VAR_2}."); //"{STR_VAR_1} forgot {STR_VAR_3}.\pAnd‥\p{STR_VAR_1}\nlearned {STR_VAR_2}."
const u8 gText_GiveUpTryingToTeachNewMove[] = _("Give up trying to teach a new\nmove to {STR_VAR_1}?");
const u8 gText_WhichMoveShouldBeForgotten[] = _("Which move should be\nforgotten?\p"); //"Which move should be forgotten?\p"
const u8 gText_TenDashes[] = _("----------");
const u8 gText_CommStandbyAwaitingOtherPlayer[] = _("Communication standby...\nAwaiting another player to choose."); //"Communication standby‥\nAwaiting another player to choose."
...
const u8 gText_DontHaveCardNewOneInput[] = _("You donÑ have a WONDER CARD,\nso a new CARD will be input."); //"You don't have a WONDER CARD,\nso a new CARD will be input."
const u8 gText_DontHaveNewsNewOneInput[] = _("You donÑ have any WONDER NEWS,\nso new NEWS will be input."); //"You don't have any WONDER NEWS,\nso new NEWS will be input."
...
const u8 gText_HaventReceivedCardsGift[] = _("You havenÑ received the CARD's gift\nyet. Input a new CARD anyway?"); //"You haven't received the CARD's gift\nyet. Input a new CARD anyway?"
...
const u8 gText_NoMoreRoomForStamps[] = _("There's no more room for adding\nSTAMPS."); //"There's no more room for adding\nSTAMPS."
const u8 gText_RecordUploadedViaWireless[] = _("Your record has been uploaded via\nWIRELESS COMMUNICATION.");
const u8 gText_CantAcceptCardFromTrainer[] = _("You canÑ accept a WONDER CARD\nfrom this TRAINER."); //"You can't accept a WONDER CARD\nfrom this TRAINER."
const u8 gText_CantAcceptNewsFromTrainer[] = _("You canÑ accept WONDER NEWS\nfrom this TRAINER."); //"You can't accept WONDER NEWS\nfrom this TRAINER."
...
const u8 gText_CantSendGiftToTrainer[] = _("You canÑ send a MYSTERY GIFT to\nthis TRAINER."); //"You can't send a MYSTERY GIFT to\nthis TRAINER."
const u8 gText_IfThrowAwayCardEventWontHappen[] = _("If you throw away the CARD,\nits event wonÑ happen. Okay?"); //"If you throw away the CARD,\nits event won't happen. Okay?"
const u8 gText_OkayToDiscardNews[] = _("Is it okay to discard this\nNEWS item?");
const u8 gText_HaventReceivedGiftOkayToDiscard[] = _("You havenÑ received the\nGIFT. Is it okay to discard?"); //"You haven't received the\nGIFT. Is it okay to discard?"
