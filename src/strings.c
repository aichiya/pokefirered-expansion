...
const u8 gText_WithdrawMonDescription[] = _("You can withdraw\na POKéMON if you\nhave any in a BOX.");
const u8 gText_DepositMonDescription[] = _("You can deposit\nyour party\nPOKéMON in any BOX.");
const u8 gText_MoveMonDescription[] = _("You can move POKéMON that are\nstored in any BOX.");
const u8 gText_MoveItemsDescription[] = _("Move items held by BOX\n or party POKéMON.");
