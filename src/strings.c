...
const u8 gText_SummaryScreenSPATK[] = _("SP.ATK /");
const u8 gText_SummaryScreenSPDEF[] = _("SP.DEF /");
...
const u8 gText_WaitingForFriendToFinish[] = _("Waiting for your\nfriend to finish."); //"{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Waiting for your friend\nto finish…"
