...
const u8 gMoveDescription_MegaKick[] = _("A powerful kicking\nattack.");
...
const u8 gMoveDescription_Surf[] = _("A strong water-type\nattack.");
...
const u8 gMoveDescription_Strength[] = _("A powerful physical\nattack.");
...
const u8 gMoveDescription_TriAttack[] = _("Fires three kinds of \nbeams at once.");
