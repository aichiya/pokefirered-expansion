...
const u8 gMoveDescription_MegaPunch[] = _("A powerful punch\nthrown very hard.");
const u8 gMoveDescription_PayDay[] = _("Throws coins. \nGets them back later.");
...
const u8 gMoveDescription_RazorWind[] = _("1st turn: Prepare\n2nd turn: Attack");
const u8 gMoveDescription_SwordsDance[] = _("A dance that\nincreases ATTACK.");
const u8 gMoveDescription_Cut[] = _("Cuts using claws,\nscythes, etc.");
const u8 gMoveDescription_Gust[] = _("Strikes the foe\nwith a gust of wind\nwhipped up by\nwings.");
const u8 gMoveDescription_WingAttack[] = _("The foe is struck\nwith large, imposing\nwings spread wide.");
const u8 gMoveDescription_Whirlwind[] = _("Blows away the foe\n& ends battle.");
const u8 gMoveDescription_Fly[] = _("1st turn: Fly\n2nd turn: Attack");
...
const u8 gMoveDescription_MegaKick[] = _("A powerful kicking attack.");
...
const u8 gMoveDescription_HornDrill[] = _("A one-hit KO, drill attack.");
const u8 gMoveDescription_Tackle[] = _("A physical attack\nin which the user\ncharges, full body,\ninto the foe.");
const u8 gMoveDescription_BodySlam[] = _("An attack that may\ncause paralysis.");
const u8 gMoveDescription_Wrap[] = _("A long body or\nvines are used to\nwrap the foe for\ntwo to five turns.");
const u8 gMoveDescription_TakeDown[] = _("A tackle that also\nhurts the user.");
const u8 gMoveDescription_Thrash[] = _("The user rampages\nabout for two to\nthree turns, then\nbecomes confused.");
const u8 gMoveDescription_DoubleEdge[] = _("A tackle that also\nhurts the user.");
...
const u8 gMoveDescription_Surf[] = _("A strong water-type attack.");
const u8 gMoveDescription_IceBeam[] = _("An attack that may\nfreeze the foe.");
const u8 gMoveDescription_Blizzard[] = _("An attack that may\nfreeze the foe.");
const u8 gMoveDescription_Psybeam[] = _("A peculiar ray is\nshot at the foe.\nIt may leave the\nfoe confused.");
const u8 gMoveDescription_BubbleBeam[] = _("An attack that may\nlower SPEED.");
const u8 gMoveDescription_AuroraBeam[] = _("A rainbow-colored\nattack beam.\nIt may lower the\nfoe's ATTACK stat.");
const u8 gMoveDescription_HyperBeam[] = _("1st turn: Attack\n2nd turn: Rest");
const u8 gMoveDescription_Peck[] = _("The foe is jabbed\nwith a sharply\npointed beak or\nhorn.");
const u8 gMoveDescription_DrillPeck[] = _("A corkscrewing\nattack with the\nsharp beak acting\nas a drill.");
const u8 gMoveDescription_Submission[] = _("An attack that also\nhurts the user.");
const u8 gMoveDescription_LowKick[] = _("A low, tripping kick\nthat inflicts more\ndamage on heavier\nfoes.");
const u8 gMoveDescription_Counter[] = _("Returns a physical\nblow double.");
const u8 gMoveDescription_SeismicToss[] = _("The user's level\nequals damage HP.");
const u8 gMoveDescription_Strength[] = _("A powerful physical attack.");
const u8 gMoveDescription_Absorb[] = _("An attack that\nabsorbs half the\ndamage it inflicted\nto restore HP.");
const u8 gMoveDescription_MegaDrain[] = _("Steals 1/2 of the\ndamage inflicted.");
...
const u8 gMoveDescription_SolarBeam[] = _("1st turn: Prepare\n2nd turn: Attack");
...
const u8 gMoveDescription_DragonRage[] = _("Always inflicts\n40HP damage.");
...
const u8 gMoveDescription_Thunderbolt[] = _("An attack that may\ncause paralysis.");
const u8 gMoveDescription_ThunderWave[] = _("A move that may\ncause paralysis.");
const u8 gMoveDescription_Thunder[] = _("An attack that may\ncause paralysis.");
const u8 gMoveDescription_RockThrow[] = _("The foe is attacked\nwith a shower of\nsmall, easily\nthrown rocks.");
const u8 gMoveDescription_Earthquake[] = _("Tough but useless\nvs. flying foes.");
const u8 gMoveDescription_Fissure[] = _("A ground-type,\none-hit KO attack.");
const u8 gMoveDescription_Dig[] = _("1st turn: Burrow\n2nd turn: Attack");
const u8 gMoveDescription_Toxic[] = _("A poison move with\nincreasing damage.");
const u8 gMoveDescription_Confusion[] = _("A weak telekinetic\nattack that may\nalso leave the foe\nconfused.");
const u8 gMoveDescription_Psychic[] = _("An attack that may\nlower SPCL.DEF.");
...
const u8 gMoveDescription_Rage[] = _("Raises ATTACK if\nthe user is hit.");
const u8 gMoveDescription_Teleport[] = _("A move for\nfleeing from battle.");
const u8 gMoveDescription_NightShade[] = _("An attack with a\nmirage that inflicts\ndamage matching\nthe user's level.");
const u8 gMoveDescription_Mimic[] = _("Copies a move\nused by the foe.");
const u8 gMoveDescription_Screech[] = _("An ear-splitting\nscreech is emitted\nto sharply reduce\nthe foe's DEFENSE.");
const u8 gMoveDescription_DoubleTeam[] = _("Heightens evasiveness.");
...
const u8 gMoveDescription_Reflect[] = _("Raises DEFENSE\nwith a barrier.");
const u8 gMoveDescription_FocusEnergy[] = _("The user takes a\ndeep breath and\nfocuses to raise its\ncritical-hit ratio.");
const u8 gMoveDescription_Bide[] = _("Waits 2-3 turns &\nhits back double.");
const u8 gMoveDescription_Metronome[] = _("Randomly uses any\nPOKéMON move.");
const u8 gMoveDescription_MirrorMove[] = _("The user counters\nthe move last used\nby the foe with the\nsame move.");
const u8 gMoveDescription_SelfDestruct[] = _("Powerful but makes\nthe user faint.");
const u8 gMoveDescription_EggBomb[] = _("Eggs are hurled\nat the foe.");
...
const u8 gMoveDescription_FireBlast[] = _("An attack that may\ncause a burn.");
...
const u8 gMoveDescription_Swift[] = _("An attack that\nnever misses.");
const u8 gMoveDescription_SkullBash[] = _("1st turn: Prepare\n2nd turn: Attack");
...
const u8 gMoveDescription_SoftBoiled[] = _("Restores HP by 1/2\nthe user's max HP.");
const u8 gMoveDescription_HiJumpKick[] = _("A strong jumping\nknee kick. If it\nmisses, the user is\nhurt.");
const u8 gMoveDescription_Glare[] = _("The user intimidates\nthe foe with the\ndesign on its belly\nto cause paralysis.");
const u8 gMoveDescription_DreamEater[] = _("Steals HP from\na sleeping victim.");
...
const u8 gMoveDescription_SkyAttack[] = _("1st turn: Prepare\n2nd turn: Attack");
...
const u8 gMoveDescription_Flash[] = _("Blinds the foe to\nreduce accuracy.");
const u8 gMoveDescription_Psywave[] = _("An attack with\nvariable power.");
...
const u8 gMoveDescription_Explosion[] = _("Very powerful but\nmakes user faint.");
const u8 gMoveDescription_FurySwipes[] = _("The foe is raked\nwith sharp claws or\nscythes two to five\ntimes.");
const u8 gMoveDescription_Bonemerang[] = _("The user throws a\nbone that hits the\nfoe once, then once\nagain on return.");
const u8 gMoveDescription_Rest[] = _("Sleep for two turns\nto fully recover.");
const u8 gMoveDescription_RockSlide[] = _("An attack that may\ncause flinching.");
...
const u8 gMoveDescription_TriAttack[] = _("Fires three\nkinds of beams\nat once.");
const u8 gMoveDescription_SuperFang[] = _("The user attacks\nwith sharp fangs\nand halves the\nfoe's HP.");
const u8 gMoveDescription_Slash[] = _("The foe is slashed\nwith claws, etc.\nIt has a high\ncritical-hit ratio.");
const u8 gMoveDescription_Substitute[] = _("Makes a decoy with\n1/4 user's max HP.");
