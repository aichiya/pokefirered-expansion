...
#define SOUND_LIST_BGM \
        ...
        X(MUS_DUMMY_348) \
        X(MUS_DUMMY_349) \
        X(MUS_RSE_LITTLEROOT_TEST) \
        X(MUS_RSE_GSC_ROUTE38) \
        X(MUS_RSE_CAUGHT) \
        X(MUS_RSE_VICTORY_WILD) \
        X(MUS_RSE_VICTORY_GYM_LEADER) \
        X(MUS_RSE_VICTORY_LEAGUE) \
        X(MUS_RSE_C_COMM_CENTER) \
        X(MUS_RSE_GSC_PEWTER) \
        X(MUS_RSE_C_VS_LEGEND_BEAST) \
        X(MUS_RSE_ROUTE101) \
        X(MUS_RSE_ROUTE110) \
        X(MUS_RSE_ROUTE120) \
        X(MUS_RSE_PETALBURG) \
        ...
        X(MUS_RSE_GYM) \
        X(MUS_RSE_SURF) \
        X(MUS_RSE_PETALBURG_WOODS) \
        X(MUS_RSE_LEVEL_UP) \
        X(MUS_RSE_HEAL) \
        X(MUS_RSE_OBTAIN_BADGE) \
        X(MUS_RSE_OBTAIN_ITEM) \
        X(MUS_RSE_EVOLVED) \
        X(MUS_RSE_OBTAIN_TMHM) \
        X(MUS_RSE_LILYCOVE_MUSEUM) \
        X(MUS_RSE_ROUTE122) \
        X(MUS_RSE_OCEANIC_MUSEUM) \
        X(MUS_RSE_EVOLUTION_INTRO) \
        X(MUS_RSE_EVOLUTION) \
        X(MUS_RSE_MOVE_DELETED) \
        X(MUS_RSE_ENCOUNTER_GIRL) \
        X(MUS_RSE_ENCOUNTER_MALE) \
        X(MUS_RSE_ABANDONED_SHIP) \
        X(MUS_RSE_FORTREE) \
        X(MUS_RSE_BIRCH_LAB) \
        X(MUS_RSE_B_TOWER_RS) \
        X(MUS_RSE_ENCOUNTER_SWIMMER) \
        X(MUS_RSE_CAVE_OF_ORIGIN) \
        X(MUS_RSE_OBTAIN_BERRY) \
        X(MUS_RSE_AWAKEN_LEGEND) \
        X(MUS_RSE_SLOTS_JACKPOT) \
        X(MUS_RSE_SLOTS_WIN) \
        X(MUS_RSE_TOO_BAD) \
        X(MUS_RSE_ROULETTE) \
        X(MUS_RSE_LINK_CONTEST_P1) \
        X(MUS_RSE_LINK_CONTEST_P2) \
        X(MUS_RSE_LINK_CONTEST_P3) \
        X(MUS_RSE_LINK_CONTEST_P4) \
        X(MUS_RSE_ENCOUNTER_RICH) \
        X(MUS_RSE_VERDANTURF) \
        X(MUS_RSE_RUSTBORO) \
        ...
        X(MUS_RSE_CYCLING) \
        X(MUS_RSE_POKE_MART) \
        X(MUS_RSE_LITTLEROOT) \
        X(MUS_RSE_MT_CHIMNEY) \
        X(MUS_RSE_ENCOUNTER_FEMALE) \
        X(MUS_RSE_LILYCOVE) \
        X(MUS_RSE_ROUTE111) \
        X(MUS_RSE_HELP) \
        X(MUS_RSE_UNDERWATER) \
        X(MUS_RSE_VICTORY_TRAINER) \
        X(MUS_RSE_TITLE) \
        X(MUS_RSE_INTRO) \
        X(MUS_RSE_ENCOUNTER_MAY) \
        X(MUS_RSE_ENCOUNTER_INTENSE) \
        X(MUS_RSE_ENCOUNTER_COOL) \
        X(MUS_RSE_ROUTE113) \
        X(MUS_RSE_ENCOUNTER_AQUA) \
        X(MUS_RSE_FOLLOW_ME) \
        X(MUS_RSE_ENCOUNTER_BRENDAN) \
        X(MUS_RSE_EVER_GRANDE) \
        X(MUS_RSE_ENCOUNTER_SUSPICIOUS) \
        X(MUS_RSE_VICTORY_AQUA_MAGMA) \
        X(MUS_RSE_CABLE_CAR) \
        X(MUS_RSE_GAME_CORNER) \
        X(MUS_RSE_DEWFORD) \
        X(MUS_RSE_SAFARI_ZONE) \
        X(MUS_RSE_VICTORY_ROAD) \
        X(MUS_RSE_AQUA_MAGMA_HIDEOUT) \
        X(MUS_RSE_SAILING) \
        X(MUS_RSE_MT_PYRE) \
        X(MUS_RSE_SLATEPORT) \
        X(MUS_RSE_MT_PYRE_EXTERIOR) \
        X(MUS_RSE_SCHOOL) \
        X(MUS_RSE_HALL_OF_FAME) \
        X(MUS_RSE_FALLARBOR) \
        X(MUS_RSE_SEALED_CHAMBER) \
        X(MUS_RSE_CONTEST_WINNER) \
        X(MUS_RSE_CONTEST) \
        X(MUS_RSE_ENCOUNTER_MAGMA) \
        X(MUS_RSE_INTRO_BATTLE) \
        X(MUS_RSE_ABNORMAL_WEATHER) \
        X(MUS_RSE_WEATHER_GROUDON) \
        X(MUS_RSE_SOOTOPOLIS) \
        X(MUS_RSE_CONTEST_RESULTS) \
        X(MUS_RSE_HALL_OF_FAME_ROOM) \
        X(MUS_RSE_TRICK_HOUSE) \
        X(MUS_RSE_ENCOUNTER_TWINS) \
        X(MUS_RSE_ENCOUNTER_ELITE_FOUR) \
        X(MUS_RSE_ENCOUNTER_HIKER) \
        X(MUS_RSE_CONTEST_LOBBY) \
        X(MUS_RSE_ENCOUNTER_INTERVIEWER) \
        X(MUS_RSE_ENCOUNTER_CHAMPION) \
        X(MUS_RSE_CREDITS) \
        X(MUS_RSE_END) \
        X(MUS_RSE_B_FRONTIER) \
        X(MUS_RSE_B_ARENA) \
        X(MUS_RSE_OBTAIN_B_POINTS) \
        X(MUS_RSE_REGISTER_MATCH_CALL) \
        X(MUS_RSE_B_PYRAMID) \
        X(MUS_RSE_B_PYRAMID_TOP) \
        X(MUS_RSE_B_PALACE) \
        X(MUS_RSE_RAYQUAZA_APPEARS) \
        X(MUS_RSE_B_TOWER) \
        X(MUS_RSE_OBTAIN_SYMBOL) \
        X(MUS_RSE_B_DOME) \
        X(MUS_RSE_B_PIKE) \
        X(MUS_RSE_B_FACTORY) \
        X(MUS_RSE_VS_RAYQUAZA) \
        X(MUS_RSE_VS_FRONTIER_BRAIN) \
        X(MUS_RSE_VS_MEW) \
        X(MUS_RSE_B_DOME_LOBBY) \
        X(MUS_RSE_VS_WILD) \
        X(MUS_RSE_VS_AQUA_MAGMA) \
        X(MUS_RSE_VS_TRAINER) \
        X(MUS_RSE_VS_GYM_LEADER) \
        X(MUS_RSE_VS_CHAMPION) \
        X(MUS_RSE_VS_REGI) \
        X(MUS_RSE_VS_KYOGRE_GROUDON) \
        X(MUS_RSE_VS_RIVAL) \
        X(MUS_RSE_VS_ELITE_FOUR) \
        X(MUS_RSE_VS_AQUA_MAGMA_LEADER) \
        X(MUS_DUMMY_484) \
        X(MUS_DUMMY_485) \
        X(MUS_DUMMY_486) \
        X(MUS_DUMMY_487) \
