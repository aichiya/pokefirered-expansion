...
#if defined(FIRERED)
#define TITLE_TEXT gString_PokemonRed_Staff
#elif defined(LEAFGREEN)
#define TITLE_TEXT gString_PokemonBlue_Staff
#endif
...
enum CreditsString
{
    ...
    CREDITS_STRING_CHARACTER_DESIGN,
    CREDITS_STRING_MUSIC,
    CREDITS_STRING_SOUND_EFFECTS,
    CREDITS_STRING_GAME_DESIGN,
    CREDITS_STRING_MONSTER_DESIGN,
    CREDITS_STRING_GAME_SCENARIO,
    CREDITS_STRING_PARAMETRIC_DESIGN,
    CREDITS_STRING_MAP_DESIGN,
    CREDITS_STRING_PRODUCT_TESTING,
    CREDITS_STRING_SPECIAL_THANKS,
    CREDITS_STRING_PRODUCERS,
    CREDITS_STRING_US_VERSION_STAFF,
    CREDITS_STRING_US_COORDINATION,
    CREDITS_STRING_TEXT_TRANSLATION,
    CREDITS_STRING_PRODUCER,
...
static const struct CreditsScrcmd sCreditsScript[] = {
    CREDITS_MAPNEXT(PALLET_TOWN, 16),
    CREDITS_PRINT(DIRECTOR, 300),
    CREDITS_PRINT(PROGRAMMERS, 300),
    CREDITS_MAPNEXT(VIRIDIAN_CITY, 16),
    CREDITS_PRINT(CHARACTER_DESIGN, 300),
    CREDITS_PRINT(MUSIC, 300),
    CREDITS_MAPNEXT(PEWTER_CITY, 16),
    CREDITS_PRINT(SOUND_EFFECTS, 300),
    CREDITS_PRINT(GAME_DESIGN, 300),
    CREDITS_MAP(CERULEAN_CITY, 16),
    CREDITS_PRINT(MONSTER_DESIGN, 300),
    CREDITS_PRINT(GAME_SCENARIO, 300),
    CREDITS_MAP(LAVENDER_TOWN, 16),
    CREDITS_PRINT(PARAMETRIC_DESIGN, 300),
    CREDITS_PRINT(MAP_DESIGN, 300),
    CREDITS_MAPNEXT(VERMILION_CITY, 16),
    CREDITS_PRINT(PRODUCT_TESTING, 300),
    CREDITS_PRINT(SPECIAL_THANKS, 300),
    CREDITS_MAPNEXT(CELADON_CITY, 16),
    CREDITS_PRINT(PRODUCERS, 300),
    CREDITS_MAPNEXT(FUCHSIA_CITY, 16),
    CREDITS_PRINT(US_VERSION_STAFF, 300),
    CREDITS_MAPNEXT(SAFFRON_CITY, 16),
    CREDITS_PRINT(US_COORDINATION, 300),
    CREDITS_MAPNEXT(CINNABAR_ISLAND, 16),
    CREDITS_PRINT(TEXT_TRANSLATION, 300),
    CREDITS_MAPNEXT(ROUTE23, 16),
    CREDITS_PRINT(PRODUCER, 300),
...
static const struct CreditsTextHeader sCreditsTexts[] = {
    { gCreditsString_Director, gCreditsString_Satoshi_Tajiri, FALSE },
    { gCreditsString_Programmers, gCreditsString_Takenori_Oota_Shigeki_Morimoto, FALSE },
    { gCreditsString_Programmers, gCreditsString_Tetsuya_Watanabe_Junichi_Masuda_Sousuke_Tamada, FALSE },
    { gCreditsString_CharacterDesign, gCreditsString_Ken_Sugimori_Atsuko_Nishida, FALSE },
    { gCreditsString_Music, gCreditsString_Junichi_Masuda, FALSE  },
    { gCreditsString_Sound_Effects, gCreditsString_Junichi_Masuda, FALSE },
    { gCreditsString_Game_Design, gCreditsString_Satoshi_Tajiri, FALSE },
    { gCreditsString_Monster_Design, gCreditsString_Ken_Sugimori_Atsuko_Nishida_Motofumo_Fuziwara, FALSE  },
    { gCreditsString_Monster_Design, gCreditsString_Shigeki_Morimoto_Satoshi_Oota_Rena_Yoshikawa, FALSE  },
    { gCreditsString_Game_Scenario, gCreditsString_Satoshi_Tajiri, FALSE  },
    { gCreditsString_Game_Scenario, gCreditsString_Ryohsuke_Taniguchi_Fumihiro_Nonomura_Hiroyuki_Zinnai, FALSE  },
    { gCreditsString_Parametric_Design, gCreditsString_Kohji_Nisino_Takeo_Nakamura, FALSE },
    { gCreditsString_Map_Design, gCreditsString_Satoshi_Tajiri_Kohji_Nisino, FALSE },
    { gCreditsString_Map_Design, gCreditsString_Kenji_Matsusima_Fumihiro_Nonomura_Ryohsuke_Taniguchi, FALSE },
    { gCreditsString_Product_Testing, gCreditsString_Akiyoshi_Kakei_Kazuki_Tsuchiya, FALSE },
    { gCreditsString_Product_Testing, gCreditsString_Takeo_Nakamura_Masamitsu_Yuda, FALSE },
    { gCreditsString_Special_Thanks, gCreditsString_Tatsuya_Hishida_Yasuhiro_Sakai, FALSE },
    { gCreditsString_Special_Thanks, gCreditsString_Wataru_Yamaguchi_Kazuyuki_Yamamoto, FALSE },
    { gCreditsString_Special_Thanks, gCreditsString_Akihito_Tomisawa_Hiroyoshi_Kawamoto_Tomomichi_Oota, FALSE },
    { gCreditsString_Producers, gCreditsString_Shigeru_Miyamoto, FALSE },
    { gCreditsString_Producers, gCreditsString_Takashi_Kawaguchi, FALSE },
    { gCreditsString_Producers, gCreditsString_Tsunekazu_Ishihara, FALSE },
    { gCreditsString_US_Version_Staff, gText_TrainerCardNull, FALSE },
    { gCreditsString_US_Coordination, gCreditsString_Gail_Tilden, FALSE  },
    { gCreditsString_US_Coordination, gCreditsString_Naoko_Kawakami_Hiro_Nakamura, FALSE  },
    { gCreditsString_US_Coordination, gCreditsString_William_Giese_Sara_Osborne, FALSE  },
    { gCreditsString_Text_Translation, gCreditsString_Nob_Ogasawara, FALSE },
    { gCreditsString_Programmers, gCreditsString_Teruki_Murakawa_Kohta_Fukui, FALSE  },
    { gCreditsString_Special_Thanks, gCreditsString_Satoru_Iwata, FALSE },
    { gCreditsString_Special_Thanks, gCreditsString_Takahiro_Harada, FALSE },
    { gCreditsString_Product_Testing, gCreditsString_Paad_Testing_NCL_Super_Mario_Club, FALSE  },
    { gCreditsString_Producer, gCreditsString_Takehiro_Izushi, FALSE  },
    { gCreditsString_Executive_Producer, gCreditsString_Hiroshi_Yamauchi, FALSE },
...
static s32 RollCredits(void)
{
    ...
    case CREDITSSCENE_PRINT_TITLE_STAFF:
        ...
        AddTextPrinterParameterized4(sCreditsMgr->windowId, FONT_NORMAL, 8, 16, 1, 2, sTextColor_Header, 0, TITLE_TEXT);
