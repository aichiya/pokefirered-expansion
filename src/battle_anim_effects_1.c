...
static const union AnimCmd sAnim_AbsorptionOrbProjectile[] =
{
    ANIMCMD_FRAME(8, 1),
    ANIMCMD_END,
};
...
static const union AnimCmd *const sHardenCombine1[] =
{
    sAnim_Harden1,
};
...
static const union AnimCmd *const sHardenCombine2[] =
{
    sAnim_Harden2,
};
...
static const union AnimCmd *const sHardenCombine3[] =
{
    sAnim_Harden3,
};
...
static const union AnimCmd *const sHardenCombine4[] =
{
    sAnim_Harden4,
};
...
static const union AnimCmd *const sHardenCombine5[] =
{
    sAnim_Harden5,
};
...
static const union AnimCmd *const sHardenCombine6[] =
{
    sAnim_Harden6,
};
...
static const union AnimCmd *const sHardenCombine7[] =
{
    sAnim_Harden7,
};
...
static const union AnimCmd *const sHardenCombine8[] =
{
    sAnim_Harden8,
};

const struct SpriteTemplate gHardenCombine1SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine1,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};

const struct SpriteTemplate gHardenCombine2SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine2,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};

const struct SpriteTemplate gHardenCombine3SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine3,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};

const struct SpriteTemplate gHardenCombine4SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine4,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};

const struct SpriteTemplate gHardenCombine5SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine5,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};

const struct SpriteTemplate gHardenCombine6SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine6,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};

const struct SpriteTemplate gHardenCombine7SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine7,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};

const struct SpriteTemplate gHardenCombine8SpriteTemplate =
{
    .tileTag = ANIM_TAG_RED_BALL,
    .paletteTag = ANIM_TAG_RED_BALL,
    .oam = &gOamData_AffineOff_ObjNormal_8x8,
    .anims = sHardenCombine8,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = AnimAbsorptionOrbCombine,
};
...
static void AnimAbsorptionOrbProjectile(struct Sprite* sprite)
{
    ...
    sprite->callback = AnimAbsorptionOrbProjectile_Step;
}

static void AnimAbsorptionOrbProjectile_Step(struct Sprite* sprite)
{
