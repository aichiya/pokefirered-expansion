...
extern const u8 gText_TMCaseType[];
...
extern const u8 gString_PokemonRed_Staff[]; // FR
extern const u8 gString_PokemonBlue_Staff[]; // LG
extern const u8 gCreditsString_Director[];
extern const u8 gCreditsString_Programmers[];
extern const u8 gCreditsString_Takenori_Oota_Shigeki_Morimoto[];
extern const u8 gCreditsString_Tetsuya_Watanabe_Junichi_Masuda_Sousuke_Tamada[];
extern const u8 gCreditsString_CharacterDesign[];
extern const u8 gCreditsString_Ken_Sugimori_Atsuko_Nishida[];
extern const u8 gCreditsString_Music[];
extern const u8 gCreditsString_Junichi_Masuda[];
extern const u8 gCreditsString_Sound_Effects[];
extern const u8 gCreditsString_Game_Design[];
extern const u8 gCreditsString_Satoshi_Tajiri[];
extern const u8 gCreditsString_Monster_Design[];
extern const u8 gCreditsString_Ken_Sugimori_Atsuko_Nishida_Motofumo_Fuziwara[];
extern const u8 gCreditsString_Shigeki_Morimoto_Satoshi_Oota_Rena_Yoshikawa[];
extern const u8 gCreditsString_Game_Scenario[];
extern const u8 gCreditsString_Ryohsuke_Taniguchi_Fumihiro_Nonomura_Hiroyuki_Zinnai[];
extern const u8 gCreditsString_Parametric_Design[];
extern const u8 gCreditsString_Kohji_Nisino_Takeo_Nakamura[];
extern const u8 gCreditsString_Map_Design[];
extern const u8 gCreditsString_Satoshi_Tajiri_Kohji_Nisino[];
extern const u8 gCreditsString_Kenji_Matsusima_Fumihiro_Nonomura_Ryohsuke_Taniguchi[];
extern const u8 gCreditsString_Product_Testing[];
extern const u8 gCreditsString_Akiyoshi_Kakei_Kazuki_Tsuchiya[];
extern const u8 gCreditsString_Takeo_Nakamura_Masamitsu_Yuda[];
extern const u8 gCreditsString_Special_Thanks[];
extern const u8 gCreditsString_Tatsuya_Hishida_Yasuhiro_Sakai[];
extern const u8 gCreditsString_Wataru_Yamaguchi_Kazuyuki_Yamamoto[];
extern const u8 gCreditsString_Akihito_Tomisawa_Hiroyoshi_Kawamoto_Tomomichi_Oota[];
extern const u8 gCreditsString_Producers[];
extern const u8 gCreditsString_Shigeru_Miyamoto[];
extern const u8 gCreditsString_Takashi_Kawaguchi[];
extern const u8 gCreditsString_Tsunekazu_Ishihara[];
extern const u8 gCreditsString_US_Version_Staff[];
extern const u8 gCreditsString_US_Coordination[];
extern const u8 gCreditsString_Gail_Tilden[];
extern const u8 gCreditsString_Naoko_Kawakami_Hiro_Nakamura[];
extern const u8 gCreditsString_William_Giese_Sara_Osborne[];
extern const u8 gCreditsString_Text_Translation[];
extern const u8 gCreditsString_Nob_Ogasawara[];
extern const u8 gCreditsString_Teruki_Murakawa_Kohta_Fukui[];
extern const u8 gCreditsString_Satoru_Iwata[];
extern const u8 gCreditsString_Takahiro_Harada[];
extern const u8 gCreditsString_Paad_Testing_NCL_Super_Mario_Club[];
extern const u8 gCreditsString_Producer[];
extern const u8 gCreditsString_Takehiro_Izushi[];
extern const u8 gCreditsString_Executive_Producer[];
extern const u8 gCreditsString_Hiroshi_Yamauchi[];
...
extern const u8 gText_Nidorina_1200Coins[];
extern const u8 gText_Nidorino_1200Coins[];
...
extern const u8 gText_SummaryScreenNo[];
extern const u8 gText_SummaryScreenType[];
extern const u8 gText_SummaryScreenOT[];
extern const u8 gText_SummaryScreenIDNo[];
extern const u8 gText_SummaryScreenITEM[];
extern const u8 gText_SummaryScreenMemo[];
extern const u8 gText_SummaryScreenHP[];
extern const u8 gText_SummaryScreenATTACK[];
extern const u8 gText_SummaryScreenDEFENSE[];
extern const u8 gText_SummaryScreenSPECIAL[];
extern const u8 gText_SummaryScreenSPEED[];
extern const u8 gText_SummaryScreenPOWER[];
extern const u8 gText_SummaryScreenACCURACY[];
extern const u8 gText_SummaryScreenEFFECT[];
...
extern const u8 gText_PokemonList2[];
extern const u8 gText_SearchNoColor[];
extern const u8 gText_Search2[];
